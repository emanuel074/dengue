    ...
    class ControleBLL
    {
        ...
        public DataTable Selecionar() 
        {
            ...
            {            
                ...
                bd = new AcessoBancoDados();
                bd.Conectar();
                dt = bd.RetDataTable("select codigoAgente, nomeProfissional, idade, cpf, n_identidade, DataNascimentoProfissional, email, sexo, estadoCivil, endereçoProfissional, bairroProfissional, N_residencia, municipio, estado, telefone, celular from cadastroAgente");
            }
            catch (Exception ex)
            {
