<?php
  ...
  $sql = "insert into registrodefocos (nome_agente,cod_agente, num_equipe, nome_morador, estado, cidade, rua, num_casa, data_visita, local_Visita, quantidade_focosAgua, quantidade_criadouros, local_tem_entulho, tipofocos1, num_focos1, tipofocos2, num_focos2, tipofocos3, num_focos3, situacao_imovel) 
  values ('$nome_agente','$cod_agente','$num_equipe','$nome_morador','$estado','$cidade','$rua','$num_casa','$data_visita','$local_Visita','$quantidade_focosAgua','$quantidade_criadouros','$local_tem_entulho','$tipofocos1','$num_focos1','$tipofocos2','$num_focos2','$tipofocos3','$num_focos3','$situacao_imovel')";
