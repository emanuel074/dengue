...
{
    public partial class ControleAgente : MetroForm
    {
        ...
        private void dataGridViewAgentes_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            cbEquipe.Text = dataGridViewAgentes.Rows[e.RowIndex].Cells[2].Value.ToString();
            txtIdade.Text = dataGridViewAgentes.Rows[e.RowIndex].Cells[3].Value.ToString();
            mkdCpf.Text = dataGridViewAgentes.Rows[e.RowIndex].Cells[4].Value.ToString();
            txtRg.Text = dataGridViewAgentes.Rows[e.RowIndex].Cells[5].Value.ToString();
            mkdDataNasc.Text = dataGridViewAgentes.Rows[e.RowIndex].Cells[6].Value.ToString();
            txtEmail.Text = dataGridViewAgentes.Rows[e.RowIndex].Cells[7].Value.ToString();
            cbSexo.Text = dataGridViewAgentes.Rows[e.RowIndex].Cells[8].Value.ToString();
            cbEstadoCivil.Text = dataGridViewAgentes.Rows[e.RowIndex].Cells[9].Value.ToString();
            txtEndereco.Text = dataGridViewAgentes.Rows[e.RowIndex].Cells[10].Value.ToString();
            txtBairro.Text = dataGridViewAgentes.Rows[e.RowIndex].Cells[11].Value.ToString();
            txtNumero.Text = dataGridViewAgentes.Rows[e.RowIndex].Cells[12].Value.ToString();
            cbMunicipio.Text = dataGridViewAgentes.Rows[e.RowIndex].Cells[13].Value.ToString();
            cbEstado.Text = dataGridViewAgentes.Rows[e.RowIndex].Cells[14].Value.ToString();
            mkdTelefone.Text = dataGridViewAgentes.Rows[e.RowIndex].Cells[15].Value.ToString();
            mkdCelular.Text = dataGridViewAgentes.Rows[e.RowIndex].Cells[16].Value.ToString();
        ...
        {
            if (txtNome.Text != "" && cbEquipe.Text !="" && txtIdade.Text != "" && mkdCpf.Text != "" && txtRg.Text != "" && mkdDataNasc.Text != "" && txtEmail.Text != "" && cbSexo.Text != "" && cbEstadoCivil.Text != "" && txtEndereco.Text != "" && txtBairro.Text != "" && txtNumero.Text != "" && cbMunicipio.Text != "" && cbEstado.Text != "" && mkdTelefone.Text != "" && mkdCelular.Text != "")
            {
                dto.NomeProfissional = txtNome.Text;
                dto.Equipe = cbEquipe.Text;
                dto.Idade = int.Parse(txtIdade.Text);
        ...
        private void cbEquipe_KeyPress(object sender, KeyPressEventArgs e)
        {
            e.Handled = true;

        }

        private void mtbPesquisar_MaskInputRejected(object sender, MaskInputRejectedEventArgs e)
        {
