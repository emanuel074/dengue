...
{
    public partial class Agendamento : MetroForm
    {
        ...
        private void btIncluir_Click(object sender, EventArgs e)
        {
            ...
            if (txtCodigo.Text != "" && txtBairro.Text != "" && txtNome.Text != "" && cmbEquipe.Text != "" && cmbPeriodo.Text != "" && mktDataMarcada.Text != "")
            {
        ...
        private void gridagente_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            if (txtCodigo.Text != "")
            {
        ...
        private void gridagente_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            cmbEquipe.Text = gridagente.Rows[e.RowIndex].Cells[5].Value.ToString();
            txtCodigo.Enabled = false;
        ...
        private void mktDataMarcada_ValueChanged(object sender, EventArgs e)
        {
